  ...
  return (
    <footer className="bg-gray-950 border-t border-gray-800">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center text-gray-600 hover:text-blue-400 transition-colors">
                <Mail className="h-4 w-4 mr-2" /> sakshisi9051@gmail.com
              </li>
              <li className="flex items-center text-gray-600 hover:text-blue-400 transition-colors">
                <Github className="h-4 w-4 mr-2" /> github.com/SakshiS010
              </li>
              <li className="flex items-center text-gray-600 hover:text-blue-400 transition-colors">
                <Linkedin className="h-4 w-4 mr-2" /> linkedin.com/in/sakshisi11
              </li>
              <li className="flex items-center text-gray-600 hover:text-blue-400 transition-colors">
                <Instagram className="h-4 w-4 mr-2" /> instagram.com/it__sakss
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-md">
              Designed & Built by Sakshi Singh © { new Date().getFullYear() } All rights reserved.
            </p>
      ...
      <div className="fixed bottom-4 left-4 z-40 flex flex-col space-y-2">
        <a
          href="https://github.com/SakshiS010"
        ...
        <a
          href="https://www.linkedin.com/in/sakshisi11/"
          rel="noopener noreferrer"
          target="_blank"
          className="p-2 bg-gray-800 rounded-full shadow-lg hover:bg-cyan-500/30 transition-colors"
        ...
        <a
          href="mailto:sakshisi9051@gmail.com"
          rel="noopener noreferrer"
          target="_blank"
          className="p-2 bg-gray-800 rounded-full shadow-lg hover:bg-cyan-500/30 transition-colors"
        ...
        <a
          href="https://www.instagram.com/it__sakss/"
          rel="noopener noreferrer"
          target="_blank"
          className="p-2 bg-gray-800 rounded-full shadow-lg hover:bg-cyan-500/30 transition-colors"
