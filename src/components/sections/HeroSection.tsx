...
export default function HeroSection() {
  ...
  const bioText = "Computer Science student driven by a passion for turning ideas into seamless digital experiences, uniting precision in development with creativity in design.";
